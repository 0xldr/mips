...
### 10.4: Ecosystem Actor and Aligned Delegate Emergency Contact Mechanism

In the event of an emergency affecting the Maker Protocol or its subDAOs, it is essential that relevant EAs and ADs can be contacted so that they may act in a timely fashion. The precise mechanism used for this shall be recommended by the Protocol Security Workstream to the Governance Facilitators for approval in a poll through the Weekly Governance Cycle.

As safeguarding the security of the Maker Protocol through the Executive Vote process is the most important responsibility of ADs, any AD that does not sign up to an approved mechanism within a reasonable timeframe of its approval will not be eligible for Prime Delegate or Reserve Delegate status.

#### 10.4.1 Emergency Contact Mechanism Criteria
...
- The mechanism should not require personal information of KYC from users.
...
#### 10.4.2: Emergency Response Firedrills

The Protocol Security Workstream and Governance Facilitators may run firedrills to test the preparedness of EAs and ADs that have been added to the Emergency Contact Mechanism. This will be done at the discretion of the Protocol Security Workstream and Governance Facilitators. The results of firedrills shall be published to maintain transparency.
